...
[CreateAssetMenu(fileName = "SquashLaunch_ClearAnimation", menuName = "Block Blast/Effects/Grid/Clear/Squash Launch Animation")]
public class SquashLaunchClearAnimationSO : ClearAnimationSO
{
