...
[CreateAssetMenu(fileName = "NewVortexTwistClearEffect", menuName = "Block Blast/Effects/Grid/Clear/Vortex Twist")]
public class VortexTwistClearEffectSO : ClearAnimationEffectSO
{
    [Header("Vortex Twist")]
