...
[CreateAssetMenu(fileName = "NewJellyWobbleClearEffect", menuName = "Block Blast/Effects/Grid/Clear/Jelly Wobble")]
public class JellyWobbleClearEffectSO : ClearAnimationEffectSO
{
    [Header("Jelly Wobble")]
