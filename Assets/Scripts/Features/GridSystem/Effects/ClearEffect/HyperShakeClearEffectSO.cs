...
[CreateAssetMenu(fileName = "NewHyperShakeClearEffect", menuName = "Block Blast/Effects/Grid/Clear/Hyper Shake")]
public class HyperShakeClearEffectSO : ClearAnimationEffectSO
{
    [Header("Hyper Shake")]
